...
if __name__ == "__main__":
    main()
# python tools/convert_checkpoint/deepspeed_to_megatron.py --target_tp 4 --target_pp 1 --input_folder ckpts/global_step7000 --output_folder ckpts/megatron_4_tp_7000